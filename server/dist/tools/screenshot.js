...
export async function takeScreenshot({ format, quality, fullPage, tabId, }) {
...
export const screenshotToolDef = {
    name: "screenshot",
    description: "Take a screenshot of the current page. Options: format (png/jpeg), quality (0-100), fullPage (boolean).",
