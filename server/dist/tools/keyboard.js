...
export async function pressKey({ key, ctrl, alt, shift, meta, tabId, }) {
...
export const keyPressToolDef = {
    name: "press-key",
    description: "Press a key or key combination on the keyboard. Supports modifiers: ctrl, alt, shift, meta",
