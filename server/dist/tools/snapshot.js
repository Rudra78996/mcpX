...
export async function takeSnapshot({ url, includeInteractive, }) {
    if (!validateUrl(url)) {
        return {
            content: [
                {
...
export const snapshotToolDef = {
    name: "snapshot",
    description: "Take a DOM snapshot of the current page with optional interactive elements detection",
