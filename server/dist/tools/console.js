...
export async function getConsoleLogs({ tabId, levels, since, limit, }) {
...
export const consoleLogsToolDef = {
    name: "console-logs",
    description: "Get console logs from the current tab. Optionally filter by levels and time range.",
